Hello! I am a PhD candidate in the Department of Mathematics at the University of Washington in Seattle, where I am lucky to be co-advised by [Dmitriy Drusvyatskiy](https://sites.google.com/uw.edu/ddrusv) and [Rekha Thomas](https://sites.math.washington.edu/~thomas/). My research interests broadly consist of questions inspired by data science and machine learning, with a particular focus on problems with an algebraic or combinatorial nature. More specifically, my recent work has concerned **kernel methods**.
...
- T. Duff, **J. Kendrick**, R. R. Thomas. [*Universal Gröbner Bases of (Universal) Multiview Ideals*.](https://arxiv.org/abs/2509.12376)
...
- M. Diaz, D. Drusvyatskiy, **J. Kendrick**, R. R. Thomas. [*Invariant Kernels: Rank Stabilization and Generalization Across Dimensions.*](https://arxiv.org/abs/2502.01886) Submitted.
- P. Cahn, E. Catania, S. Chimgee, O. Del Guercio, **J. Kendrick**. [*Dihedral Linking Invariants.*](https://arxiv.org/abs/2112.14790) Submitted.

## Projects

### [Automated Search Engine Prompt Generation for Nautical Crime](https://github.com/j4ck-k/m2pi-ncis-prompts)

This project was completed as a part of the [Math 2 Power Industry workshop in 2024](https://m2pi.ca/authors/jkendrick/cert).
...
### [Predicting Paper Retractions](https://github.com/j4ck-k/predicting-paper-retractions)
